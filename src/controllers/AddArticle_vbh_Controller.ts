...
import { saveArticleDetails, getAllArticlesFromDB, getArticleById } from '../models/AddArticle_vbh_Model';

export const vbh_saveArticleDetailsController = async (req: Request, res: Response) => {
  try {
...
export const vbh_getAllArticlesController = async (req: Request, res: Response) => {
  try {
...
export const vbh_getArticleByIdController = async (req: Request, res: Response) => {
  try {
