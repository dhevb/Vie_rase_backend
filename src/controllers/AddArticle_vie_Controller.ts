...
import { saveArticleDetails, getAllArticlesFromDB, getArticleById } from '../models/AddArticle_vie_Model';

export const vie_saveArticleDetailsController = async (req: Request, res: Response) => {
  try {
...
export const vie_getAllArticlesController = async (req: Request, res: Response) => {
  try {
...
export const vie_getArticleByIdController = async (req: Request, res: Response) => {
  try {
