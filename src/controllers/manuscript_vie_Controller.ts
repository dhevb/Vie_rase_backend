...
import { submitAuthorDetails, updateManuscriptFile, updateArticleDetails, getManuscriptsByUser } from '../models/vie_manuscriptModel';

// Controller to handle author details submission
export const vie_submitAuthorDetailsController = async (req: Request, res: Response) => {
  try {
    const {
      author_name,
      author_email,
...
export const vie_submitManuscriptFileController = async (req: Request, res: Response) => {
  try {
    if (!req.file) {
...
export const vie_submitArticleDetailsController = async (req: Request, res: Response) => {
  try {
    const manuscriptId = Number(req.body.manuscriptId);
    const user_id = req.body.userId;
...
export const vie_getManuscriptsByUserController = async (req: Request, res: Response) => {
  try {
