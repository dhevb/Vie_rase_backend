...
import { saveArticleDetails, getAllArticlesFromDB, getArticleById } from '../models/AddArticle_vbe_Model';

export const vbe_saveArticleDetailsController = async (req: Request, res: Response) => {
  try {
...
export const vbe_getAllArticlesController = async (req: Request, res: Response) => {
  try {
...
export const vbe_getArticleByIdController = async (req: Request, res: Response) => {
  try {
