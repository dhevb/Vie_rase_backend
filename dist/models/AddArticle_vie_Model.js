...
const saveArticleDetails = (articleData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (attempts < maxAttempts) {
        try {
            const [result] = yield db_1.pool.query(`INSERT INTO article_vie (DOI, ArticleInfo, ArticleDetails, Abstract, Keywords, Heading, Conclusion, Recommendations, Refrences) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
                articleData.DOI,
...
const getAllArticlesFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [rows] = yield db_1.pool.query('SELECT id, JSON_UNQUOTE(JSON_EXTRACT(ArticleDetails, "$.Title")) AS title FROM article_vie');
...
const getArticleById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const [rows] = yield db_1.pool.query('SELECT * FROM article_vie WHERE id = ?', [id]);
        ...
        const result = {
            DOI: article.DOI,
            ArticleInfo: JSON.parse(article.ArticleInfo), // Parse JSON
            ArticleDetails: JSON.parse(article.ArticleDetails), // Parse JSON
            Abstract: article.Abstract,
            Keywords: article.Keywords,
            Heading: JSON.parse(article.Heading), // Parse JSON
