...
const saveArticleDetails = (articleData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (attempts < maxAttempts) {
        try {
            const [result] = yield db_1.pool.query(`INSERT INTO article_vbe (DOI, ArticleInfo, ArticleDetails, Abstract, Keywords, Heading, Conclusion, Recommendations, Refrences) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
                articleData.DOI,
...
const getAllArticlesFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [rows] = yield db_1.pool.query('SELECT id, JSON_UNQUOTE(JSON_EXTRACT(ArticleDetails, "$.Title")) AS title FROM article_vbe');
...
const getArticleById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const [rows] = yield db_1.pool.query('SELECT * FROM article_vbe WHERE id = ?', [id]);
