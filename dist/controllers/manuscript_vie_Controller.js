...
exports.vie_getManuscriptsByUserController = exports.vie_submitArticleDetailsController = exports.vie_submitManuscriptFileController = exports.vie_submitAuthorDetailsController = void 0;
const vie_manuscriptModel_1 = require("../models/vie_manuscriptModel");
// Controller to handle author details submission
const vie_submitAuthorDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield (0, vie_manuscriptModel_1.submitAuthorDetails)({
            author_name,
            author_email,
            author_designation,
            author_organization,
...
exports.vie_submitAuthorDetailsController = vie_submitAuthorDetailsController;
// Controller to handle manuscript file upload
const vie_submitManuscriptFileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!req.file) {
        ...
        yield (0, vie_manuscriptModel_1.updateManuscriptFile)(manuscriptId, filePath, user_id);
...
exports.vie_submitManuscriptFileController = vie_submitManuscriptFileController;
// Controller to handle article details submission
const vie_submitArticleDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const manuscriptId = Number(req.body.manuscriptId);
        const user_id = req.body.userId;
        if (isNaN(manuscriptId) || manuscriptId <= 0) {
        ...
        yield (0, vie_manuscriptModel_1.updateArticleDetails)(manuscriptId, req.body, user_id);
...
exports.vie_submitArticleDetailsController = vie_submitArticleDetailsController;
// Controller to get all manuscripts submitted by a user
const vie_getManuscriptsByUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.userId;
        if (!userId) {
            return res.status(400).json({ error: 'User ID is required.' });
        }
        const manuscripts = yield (0, vie_manuscriptModel_1.getManuscriptsByUser)(userId);
        res.status(200).json({
...
exports.vie_getManuscriptsByUserController = vie_getManuscriptsByUserController;
