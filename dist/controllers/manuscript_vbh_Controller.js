...
exports.vbh_getManuscriptsByUserController = exports.vbh_submitArticleDetailsController = exports.vbh_submitManuscriptFileController = exports.vbh_submitAuthorDetailsController = void 0;
const vbh_manuscriptModel_1 = require("../models/vbh_manuscriptModel");
// Controller to handle author details submission
const vbh_submitAuthorDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield (0, vbh_manuscriptModel_1.submitAuthorDetails)({
            author_name,
            author_email,
            author_designation,
            author_organization,
...
exports.vbh_submitAuthorDetailsController = vbh_submitAuthorDetailsController;
// Controller to handle manuscript file upload
const vbh_submitManuscriptFileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!req.file) {
        ...
        yield (0, vbh_manuscriptModel_1.updateManuscriptFile)(manuscriptId, filePath, user_id);
...
exports.vbh_submitManuscriptFileController = vbh_submitManuscriptFileController;
// Controller to handle article details submission
const vbh_submitArticleDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const manuscriptId = Number(req.body.manuscriptId);
        const user_id = req.body.userId;
        if (isNaN(manuscriptId) || manuscriptId <= 0) {
        ...
        yield (0, vbh_manuscriptModel_1.updateArticleDetails)(manuscriptId, req.body, user_id);
...
exports.vbh_submitArticleDetailsController = vbh_submitArticleDetailsController;
// Controller to get all manuscripts submitted by a user
const vbh_getManuscriptsByUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.userId;
        if (!userId) {
            return res.status(400).json({ error: 'User ID is required.' });
        }
        const manuscripts = yield (0, vbh_manuscriptModel_1.getManuscriptsByUser)(userId);
        res.status(200).json({
...
exports.vbh_getManuscriptsByUserController = vbh_getManuscriptsByUserController;
