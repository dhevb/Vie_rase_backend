...
exports.getArticleByIdController = exports.getAllArticlesController = exports.saveArticleDetailsController = void 0;
const AddArticleModel_1 = require("../models/AddArticleModel");
const saveArticleDetailsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const articleData = req.body;
        if (!articleData) {
            return res.status(400).json({ error: 'No data provided.' });
        }
        const articleId = yield (0, AddArticleModel_1.saveArticleDetails)(articleData);
        res.status(201).json({
...
exports.saveArticleDetailsController = saveArticleDetailsController;
...
const getAllArticlesController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const articles = yield (0, AddArticleModel_1.getAllArticlesFromDB)();
...
const getArticleByIdController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const article = yield (0, AddArticleModel_1.getArticleById)(articleId);
        if (!article) {
